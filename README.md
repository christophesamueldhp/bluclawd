...
version (skip, jump, look or spin), and clicking it plays jump or look;
`"prefersReducedMotion": true` in settings turns both off, and
`BLUCLAWD_FORCE_FIRST_LAUNCH=1` replays the entrance.
